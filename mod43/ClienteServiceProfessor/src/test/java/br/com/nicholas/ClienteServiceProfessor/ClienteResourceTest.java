...
import br.com.nicholas.ClienteServiceProfessor.config.OpenAPIConfig;
import br.com.nicholas.ClienteServiceProfessor.controller.ClienteResource;
import br.com.nicholas.ClienteServiceProfessor.domain.Cliente;
import br.com.nicholas.ClienteServiceProfessor.exception.EntityNotFoundException;
import br.com.nicholas.ClienteServiceProfessor.usecase.BuscaCliente;
import br.com.nicholas.ClienteServiceProfessor.usecase.CadastroCliente;
...
//	@Test
	public void pesquisarPorIdTest() {
        Cliente cliente1 = Cliente.builder().id("1").nome("Nicholas 1").build();
...
//	@Test
	public void cadastrarTest() {
        Cliente cliente1 = Cliente.builder().id("1").nome("Nicholas 1")
