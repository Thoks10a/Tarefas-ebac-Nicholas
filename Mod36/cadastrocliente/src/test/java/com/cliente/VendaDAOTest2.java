...
import com.cliente.dao.generic.jdbc.ConnectionFactory;
...
public class VendaDAOTest2 {
    ...
    public void init() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        this.estoque = cadastrarEstoque("A1", "caixa");
    }
    ...
    private void excluirEstoque() throws DAOException {
        ...
        for (Estoque esto : list) {
            this.estoqueDao.excluir(esto.getCodigo());
        }
    }
    ...
    private Estoque cadastrarEstoque(String codigo, String nome)
            throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
